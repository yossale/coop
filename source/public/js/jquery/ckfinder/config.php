...
function CheckAuthentication()
{
	...
	if (isset($_SESSION['coop_users']['user_id']) && !empty($_SESSION['coop_users']['user_id']))
	{
		return true;	
	}
	else 
...
$config['LicenseName'] = 'www.cooptlv.org';
$config['LicenseKey'] = '7JX1-SQHY-JGXN-J81H-KJRT-P841-S9QS';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = '/home/eyalr/ws/projects/coop/branches/production/public/attachments/';
