...
<div class="section">
	...
	{if $report_is_locked != TRUE}
		<!-- Change SQL value to 1 (also need to think how to change back) -->
		<div class="content list">
		<form action="" method="POST">
			<textarea name="report_content" class="fckme">{$content|stripslashes}</textarea>		
			{if $coop_id == 1}<input type="checkbox" name="email" value="1" id="email"><label for="email">שלח העתק למייל הקואופ</label>{/if}<br />
